...
parser = argparse.ArgumentParser(description="Dual-Stage Multiscale Transformer")
parser.add_argument('--template', default='dsmt', help='You can set various templates in option.py')
...
parser.add_argument('--outf', type=str, default='./exp/dsmt/', help='saving_path')

# Model specifications
parser.add_argument('--method', type=str, default='dsmt', help='method name')
